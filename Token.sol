...
contract ERC20Token is owned, TokenERC20 {
    ...
    uint256 public sellPrice = 10000000000000;        // Initialization with default value
...
*************************************************************/
	...
	function getTokenAMT(uint256 amtETH) public constant returns (uint256) {
